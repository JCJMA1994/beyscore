  ...
  Future<void> _triggerManualSync() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('¡Arsenal de Combos y Decks sincronizados con la nube!'),
        ...
        child: Column(
          ...
          children: [
            ...
            _optionTile(
              ...
              title: _isSyncing ? 'Sincronizando con la nube...' : 'Sincronizar Arsenal con la Nube',
              subtitle: 'Toca aquí para subir tus Decks y Combos existentes a Supabase',
              color: AppColors.x,
