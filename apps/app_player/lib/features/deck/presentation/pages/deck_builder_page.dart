...
class _DeckBuilderPageState extends State<DeckBuilderPage> {
  ...
  Future<void> _saveDeck() async {
    ...
    // Persist combos in repository (ensuring meta combos or freshly built combos exist in DB)
    await _comboRepo.save(_combo1!);
    await _comboRepo.save(_combo2!);
              ...
              appBar: AppBar(
                ...
                actions: [
                  TextButton.icon(
                    ...
                    onPressed: () {
                      const presets = MetaPresetService.popularPresets;
                      if (presets.length >= 3) {
                        setState(() {
                          _combo1 = presets[0].toCombo(id: 'meta-combo-1');
                          _combo2 = presets[1].toCombo(id: 'meta-combo-2');
                          _combo3 = presets[2].toCombo(id: 'meta-combo-3');
                          _nameController.text = 'Meta Deck 3on3 (S-Tier)';
                        });
                      }
                    },
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSlotCard(
                      ...
                      combo: _combo1,
                      bladesMap: bladesMap,
                      hasConflict: conflict12 || conflict13,
                    ...
                    if (conflict13)
                      _buildConflictLink('MISMA PIEZA REPETIDA ENTRE BEY 1 Y BEY 3'),
                    ...
                    _buildSlotCard(
                      ...
                      combo: _combo3,
                      bladesMap: bladesMap,
                      hasConflict: conflict23 || conflict13,
